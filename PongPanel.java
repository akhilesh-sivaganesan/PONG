...
public class PongPanel extends JPanel {
   ...
   //5)  *********  What else needs be drawn?
      ...
      */
      ...
      if(player1Score == maxScore) {
    	  ...
    	  graphics.drawString("PLAYER 1 WINS!", FRAME/4, FRAME/3);
      ...
      if(player2Score == maxScore) {
          ...
          graphics.drawString("to", FRAME/2, FRAME/2);
    	  graphics.setColor(Color.ORANGE);
    	  graphics.drawString("PLAYER 2 WINS!", FRAME/4, FRAME/3);
   ...
   private class Key extends KeyAdapter
   {
      public void keyPressed(KeyEvent e)
      {
         ...
         if (leftUp && (leftBumper.getY() > 0))
            leftBumper.setY(leftBumper.getY() - 10);
         if(leftDown && ((leftBumper.getY() + leftBumper.getHeight())< FRAME))
            leftBumper.setY(leftBumper.getY() + 10);
